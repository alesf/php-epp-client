 ...
 <response>
   ...
   <trID>
    ...
    public function testPollFailedResponse()
    {
        ...
        // TODO: failed asset
        // $this->expectException('Metaregistrar\EPP\eppException', 'Type of message cannot be determined on EPP poll message');
