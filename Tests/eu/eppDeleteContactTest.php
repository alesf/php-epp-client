...
class eppDeleteContactTest extends eppTestCase
{
    ...
    {
        $message = null;
        $contacthandle = 'c'.self::randomnumber(6);
        $contact = new Metaregistrar\EPP\eppContactHandle($contacthandle);
        $delete = new Metaregistrar\EPP\eppDeleteContactRequest($contact);
        $response = $this->conn->writeandread($delete);
        $this->assertInstanceOf('Metaregistrar\EPP\eppDeleteResponse', $response);
        ...
        $this->assertEquals('Error 2303: Object does not exist; contactid:'.$contacthandle.' (The contact could not be found.)', $message);
    }
    ...
    {
        $message = null;
        $contacthandle = self::randomstring(6);
        $contact = new Metaregistrar\EPP\eppContactHandle($contacthandle);
        $delete = new Metaregistrar\EPP\eppDeleteContactRequest($contact);
        $response = $this->conn->writeandread($delete);
        $this->assertInstanceOf('Metaregistrar\EPP\eppDeleteResponse', $response);
        ...
        $this->assertEquals('Error 2005: Parameter value syntax error; contactid:'.$contacthandle.' (Invalid contact alias.)', $message);
    }
}
